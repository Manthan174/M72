...
const Navbar = () => {
  ...
  return (
    <div className='w-full top-0 items-start flex fixed justify-between z-4'>
      <div className='p-2 '>
        <div className=' lg:w-28 w-26'>
       ...
       className='lg:h-13 h-11 relative lg:w-60 w-40 bg-black'>
        ...
        <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full '>
         ...
         <div className='relative h-full lg:px-6 px-7  flex flex-col justify-center items-end lg:gap-1.5 gap-1'>
            <div className="lg:w-14 w-11 lg:h-[0.06vw] h-[0.3vw] bg-white"></div>
            <div className="lg:w-8 w-6 lg:h-[0.06vw] h-[0.3vw] bg-white"></div>
        </div>
       </div>
    </div>
  )
